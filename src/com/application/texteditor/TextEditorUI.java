...
public class TextEditorUI extends UI implements BroadcastListener {
	...
	input = input.trim();
	input = input.replace('�', 'a').replace('�', 'a').replace('�', 'a').replace('�', 'a').replace('�', 'a').replace('�', 'A').replace('�', 'A')
		.replace('�', 'A').replace('�', 'A');
	input = input.replace('�', 'e').replace('�', 'e').replace('�', 'e').replace('�', 'e').replace('�', 'E').replace('�', 'E').replace('�', 'E').replace('�',
		'E');
	input = input.replace('�', 'i').replace('�', 'i').replace('�', 'i').replace('�', 'i').replace('�', 'I').replace('�', 'I').replace('�', 'I').replace('�',
		'I');
	input = input.replace('�', 'o').replace('�', 'o').replace('�', 'o').replace('�', 'o').replace('�', 'O').replace('�', 'O').replace('�', 'O').replace('�',
		'O');
	input = input.replace('�', 'u').replace('�', 'u').replace('�', 'u').replace('�', 'u').replace('�', 'U').replace('�', 'U').replace('�', 'U').replace('�',
		'U');
	input = input.replace('�', 'c').replace('�', 'C').replace('�', 'n').replace('�', 'N');
