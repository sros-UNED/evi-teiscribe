 ...
 */
public class ServiceNotAvailableView extends CustomComponent implements View {
    private static final long serialVersionUID = -8557214981207424713L;

    /**
     * Constructor for service not aviable view.
     * <p>
     * Creates a view to show that service is not aviable
     * </p>
     */
    public ServiceNotAvailableView() {
	...
	Label content = new Label(Labels.getString("serviceNotAvailable"));
