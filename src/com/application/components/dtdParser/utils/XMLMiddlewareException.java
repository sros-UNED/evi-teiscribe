...
public class XMLMiddlewareException extends Exception {
    private static final long serialVersionUID = -1703086217325407641L;
     ...
     *
     * @param e
     *            The exception to be wrapped in a XMLMiddlewareException.
     */
     ...
     *
     * <p>
     * If there is an embedded exception, and if the XMLMiddlewareException has no detail message of its own, this method will return the detail message from
