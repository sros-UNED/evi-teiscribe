...
public class DTDSerializer implements Serializable {
    // ********************************************************************
    // Private variables
    // ********************************************************************
    private static final long serialVersionUID = 4661350561369452473L;
    private DTD dtd;
    private Writer writer = null;
    /** Defines whether to perform pretty printing */
    ...
    // COMMENTEND = " -->",
    // COMMENTSTART = "<!-- ",
	    DECLSTART = "<!", SEQSEPARATOR = ", ", QUOTENTITYREF = "&quot;", RETURN = System.getProperty("line.separator");
    private static final int DECLEND = '>', GROUPEND = ')', GROUPSTART = '(', ONEORMORE = '+', OPTIONAL = '?', POUND = '#', SPACE = ' ', ZEROORMORE = '*',
     ...
     *            The Writer.
     * @param pretty
     *            Whether to perform pretty printing.
     */
    public void serialize(DTD dtd, Writer writer, boolean pretty) throws IOException {
	this.dtd = dtd;
	this.writer = writer;
	this.pretty = pretty;
    ...
    private void writeRef(Reference ref) throws IOException {
    ...
    @SuppressWarnings("rawtypes")
    private void writeEnumeration(Vector enumeration, boolean isNotation) throws IOException {
	if (isNotation) {
