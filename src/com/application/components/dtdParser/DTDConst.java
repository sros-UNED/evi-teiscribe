 ...
 *
 * <p>
 * These are used by DTDParser and DTDSerializer.
 * </p>
 *
...
public class DTDConst implements Serializable {
    /**
	 * 
	 */
    private static final long serialVersionUID = 4581089674369084900L;
    // *********************************************************************
    // DTD Strings
    // *********************************************************************
    ...
    public static final String[] KEYWDS = { KEYWD_ANY, KEYWD_ATTLIST, KEYWD_CDATA, KEYWD_ELEMENT, KEYWD_EMPTY, KEYWD_ENTITY, KEYWD_ENTITIES, KEYWD_FIXED,
	    KEYWD_ID, KEYWD_IDREF, KEYWD_IDREFS, KEYWD_IMPLIED, KEYWD_NDATA, KEYWD_NMTOKEN, KEYWD_NMTOKENS, KEYWD_NOTATION, KEYWD_PCDATA, KEYWD_PUBLIC,
	    KEYWD_REQUIRED, KEYWD_SYSTEM };
    ...
    public static final int[] KEYWD_TOKENS = { KEYWD_TOKEN_ANY, KEYWD_TOKEN_ATTLIST, KEYWD_TOKEN_CDATA, KEYWD_TOKEN_ELEMENT, KEYWD_TOKEN_EMPTY,
	    KEYWD_TOKEN_ENTITY, KEYWD_TOKEN_ENTITIES, KEYWD_TOKEN_FIXED, KEYWD_TOKEN_ID, KEYWD_TOKEN_IDREF, KEYWD_TOKEN_IDREFS, KEYWD_TOKEN_IMPLIED,
	    KEYWD_TOKEN_NDATA, KEYWD_TOKEN_NMTOKEN, KEYWD_TOKEN_NMTOKENS, KEYWD_TOKEN_NOTATION, KEYWD_TOKEN_PCDATA, KEYWD_TOKEN_PUBLIC, KEYWD_TOKEN_REQUIRED,
	    KEYWD_TOKEN_SYSTEM };
}
