...
public class ElementType implements Serializable {
    ...
    // Constants
    // ********************************************************************
    private static final long serialVersionUID = 8175519443207047140L;
     ...
     *
     * @param uri
     *            Namespace URI of the element type. May be null.
     * @param localName
     *            Local name of the element type.
     * @param prefix
     *            Namespace prefix of the element type. May be null.
     */
